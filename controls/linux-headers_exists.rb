title 'Tests to confirm linux-headers libraries exist'
...
control 'core-plans-linux-headers' do
  impact 1.0
  title 'Ensure linux-headers libraries exist as expected'
  desc '
  To test that the libraries that linux-headers export are in the correct file path, we first find the file path for the package.
